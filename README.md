...
Бот запустится в режиме long polling. Планировщик каждый день в **23:55** проверяет, последний ли день месяца; если да — закрывает тур и создаёт следующий сезон с ротацией.
